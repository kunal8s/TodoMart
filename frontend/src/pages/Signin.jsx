...
const SignIn = () => {
  ...
  const handleGoogleSignIn = () => {
    ...
    // For example: await auth.signInWithGoogle();
  };
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">
              Sign in to your TodoMART account
            </p>
          </div>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block text-gray-900 w-full pl-10 pr-4 py-3 border ${errors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-purple-500 focus:ring-purple-500'} rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-opacity-20 transition-all duration-200`}
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="cursor-pointer text-sm font-medium text-purple-600 hover:text-purple-500 transition-colors duration-200"
                  >
                    Forgot password?
                  </button>
                </div>
          ...
          <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              ...
              <div className="flex items-center">
                ...
                <span className="font-mono text-gray-700">demopassword</span>
              </div>
            </div>
          </div>
        </div>
